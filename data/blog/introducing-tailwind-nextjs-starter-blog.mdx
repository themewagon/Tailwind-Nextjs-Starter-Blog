...
images:
  [
    "/Tailwind-Nextjs-Starter-Blog/static/images/canada/mountains.jpg",
    "/Tailwind-Nextjs-Starter-Blog/static/images/canada/toronto.jpg",
  ]
authors: ["default", "sparrowhawk"]
---

![tailwind-nextjs-banner](/Tailwind-Nextjs-Starter-Blog/static/images/twitter-card.png)
...
> [!CAUTION]
> This is the README of version 1 of the template. It is kept for historical reasons, but is no longer supported. It also serves as a nice example of Github Alert. For the actual documentation, please refer to the Github repository.
...
draft: false
summary: 'Looking for a performant, out of the box template, with all the best in web technology to support your blogging needs? Checkout the Tailwind Nextjs Starter Blog template.'
images: ['/Tailwind-Nextjs-Starter-Blog/static/images/canada/mountains.jpg', '/Tailwind-Nextjs-Starter-Blog/static/images/canada/toronto.jpg']
authors: ['default', 'sparrowhawk']
layout: PostLayout
canonicalUrl: https://themewagon.github.io/Tailwind-Nextjs-Starter-Blog
---
```
